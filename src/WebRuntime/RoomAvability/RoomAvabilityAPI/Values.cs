...
{
    internal partial class Values : IServiceOperations<RoomAvabilityAPI>, IValues
    {
        /// <summary>
        ...
        /// </param>
        internal Values(RoomAvabilityAPI client)
        {
            this._client = client;
        }
        
        private RoomAvabilityAPI _client;
        
        /// <summary>
        /// Gets a reference to the RoomAvability.RoomAvabilityAPI.
        /// </summary>
        public RoomAvabilityAPI Client
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> DeleteByIdWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> PostByValueWithOperationResponseAsync(string value, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (value == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "PostByValueAsync", tracingParameters);
            }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> PutByIdAndValueWithOperationResponseAsync(int id, string value, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (value == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("id", id);
                tracingParameters.Add("value", value);
                ServiceClientTracing.Enter(invocationId, this, "PutByIdAndValueAsync", tracingParameters);
            }
